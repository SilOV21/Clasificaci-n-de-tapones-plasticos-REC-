...
static const _CalibrateCamera_Request_type_support_symbol_names_t _CalibrateCamera_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lra_vision, srv, CalibrateCamera_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lra_vision, srv, CalibrateCamera_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lra_vision, srv, CalibrateCamera_Request)() {
  return &::lra_vision::srv::rosidl_typesupport_c::CalibrateCamera_Request_message_type_support_handle;
}
...
static const _CalibrateCamera_Response_type_support_symbol_names_t _CalibrateCamera_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lra_vision, srv, CalibrateCamera_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lra_vision, srv, CalibrateCamera_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lra_vision, srv, CalibrateCamera_Response)() {
  return &::lra_vision::srv::rosidl_typesupport_c::CalibrateCamera_Response_message_type_support_handle;
}
...
static const _CalibrateCamera_type_support_symbol_names_t _CalibrateCamera_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lra_vision, srv, CalibrateCamera)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lra_vision, srv, CalibrateCamera)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, lra_vision, srv, CalibrateCamera)() {
  return &::lra_vision::srv::rosidl_typesupport_c::CalibrateCamera_service_type_support_handle;
}
