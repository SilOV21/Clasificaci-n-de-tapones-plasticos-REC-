...
#include "lra_vision/srv/detail/calibrate_camera__rosidl_typesupport_fastrtps_c.h"
...
using _CalibrateCamera_Request__ros_msg_type = lra_vision__srv__CalibrateCamera_Request;
...
size_t get_serialized_size_lra_vision__srv__CalibrateCamera_Request(
  const void * untyped_ros_message,
...
static uint32_t _CalibrateCamera_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lra_vision__srv__CalibrateCamera_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lra_vision
size_t max_serialized_size_lra_vision__srv__CalibrateCamera_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lra_vision__srv__CalibrateCamera_Request;
    is_plain =
      (
...
static size_t _CalibrateCamera_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lra_vision__srv__CalibrateCamera_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lra_vision, srv, CalibrateCamera_Request)() {
...
using _CalibrateCamera_Response__ros_msg_type = lra_vision__srv__CalibrateCamera_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lra_vision
size_t get_serialized_size_lra_vision__srv__CalibrateCamera_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CalibrateCamera_Response__ros_msg_type * ros_message = static_cast<const _CalibrateCamera_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_lra_vision__srv__CalibrateCamera_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lra_vision
size_t max_serialized_size_lra_vision__srv__CalibrateCamera_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lra_vision__srv__CalibrateCamera_Response;
    is_plain =
      (
...
static size_t _CalibrateCamera_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lra_vision__srv__CalibrateCamera_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lra_vision, srv, CalibrateCamera_Response)() {
...
// already included above
// #include "lra_vision/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "lra_vision/srv/calibrate_camera.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lra_vision, srv, CalibrateCamera)() {
