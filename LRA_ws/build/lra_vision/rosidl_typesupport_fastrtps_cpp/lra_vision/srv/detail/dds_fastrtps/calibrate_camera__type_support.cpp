...
#include "lra_vision/srv/detail/calibrate_camera__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lra_vision::srv::CalibrateCamera_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lra_vision::srv::CalibrateCamera_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lra_vision::srv::CalibrateCamera_Request *>(
    untyped_ros_message);
...
{
  return &lra_vision::srv::typesupport_fastrtps_cpp::_CalibrateCamera_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lra_vision::srv::CalibrateCamera_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lra_vision::srv::CalibrateCamera_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lra_vision::srv::CalibrateCamera_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &lra_vision::srv::typesupport_fastrtps_cpp::_CalibrateCamera_Response__handle;
}
...
{
  return &lra_vision::srv::typesupport_fastrtps_cpp::_CalibrateCamera__handle;
}
