...
class Metaclass_CalibrateCamera(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'lra_vision.srv.CalibrateCamera')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from lra_vision.srv import _calibrate_camera
...
class CalibrateCamera(metaclass=Metaclass_CalibrateCamera):
    from lra_vision.srv._calibrate_camera import CalibrateCamera_Request as Request
    from lra_vision.srv._calibrate_camera import CalibrateCamera_Response as Response
