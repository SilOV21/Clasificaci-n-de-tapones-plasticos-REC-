...
impl Default for CalibrateCamera_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::CalibrateCamera_Request::default())
  }
}

impl rosidl_runtime_rs::Message for CalibrateCamera_Request {
  type RmwMsg = super::srv::rmw::CalibrateCamera_Request;
...
impl Default for CalibrateCamera_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::CalibrateCamera_Response::default())
  }
}

impl rosidl_runtime_rs::Message for CalibrateCamera_Response {
  type RmwMsg = super::srv::rmw::CalibrateCamera_Response;
